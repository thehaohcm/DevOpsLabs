...
4. Generics and Collections
  ...
  - List and ArrayList:
    + List<?> means list is a List of **everything**, depends on the type of the first item. List<?> is not the same as List<Object>. Never has something like "new ArrayList<?>"
